...
function showAddChild(parent) { editItem.value = null; form.parentCode = parent.categoryCode; form.categoryName = ''; form.viewCode = ''; modalOpen.value = true; }
...
async function handleDelete(code) { await bizCategoryApi.delete(code); message.success('删除成功'); loadData(); }
onMounted(loadData);
