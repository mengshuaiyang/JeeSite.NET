...
function showAddChild(parent) { editItem.value = null; form.parentCode = parent.menuCode; form.menuName = ''; form.menuHref = ''; form.permission = ''; form.menuIcon = ''; modalOpen.value = true; }
...
async function handleDelete(code) { await menuApi.delete(code); message.success('删除成功'); loadData(); }
onMounted(loadData);
    ...
    if (column.key === 'action') {
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.a, __VLS_intrinsicElements.a)({
            ...{ onClick: (...[$event]) => {
                    if (!(column.key === 'action'))
                        return;
                    __VLS_ctx.handleDelete(record.menuCode);
                } },
        });
        var __VLS_20;
    }
...
const __VLS_22 = __VLS_asFunctionalComponent(__VLS_21, new __VLS_21({
    ...
    title: (__VLS_ctx.editItem ? '编辑菜单' : '新增菜单'),
...
const __VLS_54 = __VLS_asFunctionalComponent(__VLS_53, new __VLS_53({
    value: (__VLS_ctx.form.permission),
}));
