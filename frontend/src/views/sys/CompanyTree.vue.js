...
function showAddChild(parent) { editItem.value = null; form.parentCode = parent.companyCode; form.companyName = ''; form.viewCode = ''; form.areaCode = ''; modalOpen.value = true; }
...
async function handleDelete(code) { await companyApi.delete(code); message.success('删除成功'); loadData(); }
onMounted(loadData);
    ...
    if (column.key === 'action') {
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.a, __VLS_intrinsicElements.a)({
            ...{ onClick: (...[$event]) => {
                    if (!(column.key === 'action'))
                        return;
                    __VLS_ctx.handleDelete(record.companyCode);
                } },
        });
        var __VLS_20;
    }
...
const __VLS_38 = __VLS_asFunctionalComponent(__VLS_37, new __VLS_37({
    value: (__VLS_ctx.form.companyName),
}));
