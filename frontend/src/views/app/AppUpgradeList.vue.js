...
const list = ref([]);
const form = reactive({ appCode: '', upTitle: '', upContent: '', upVersion: undefined, upType: '', apkUrl: '' });
const columns = [
...
async function loadData() {
    loading.value = true;
    const res = await appFeedbackApi.upgradeList();
    if (res.data)
        list.value = res.data;
    loading.value = false;
}
...
async function handleDelete(id) { await appFeedbackApi.upgradeDelete(id); message.success('删除成功'); loadData(); }
onMounted(loadData);
...
const __VLS_22 = __VLS_asFunctionalComponent(__VLS_21, new __VLS_21({
    ...
    title: (__VLS_ctx.editItem ? '编辑APP升级' : '新增APP升级'),
...
const __VLS_54 = __VLS_asFunctionalComponent(__VLS_53, new __VLS_53({
    value: (__VLS_ctx.form.upContent),
    rows: "4",
}));
...
const __VLS_61 = {}.AInputNumber;
/** @type {[typeof __VLS_components.AInputNumber, typeof __VLS_components.aInputNumber, ]} */ ;
// @ts-ignore
const __VLS_62 = __VLS_asFunctionalComponent(__VLS_61, new __VLS_61({
    value: (__VLS_ctx.form.upVersion),
    ...{ style: {} },
}));
