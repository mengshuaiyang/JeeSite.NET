...
- [一、模块概述](#一、模块概述)
  - [1.1 模块定位](#11-模块定位)
  - [1.2 核心能力](#12-核心能力)
  - [1.3 与其他模块的关系](#13-与其他模块的关系)
- [二、核心实体](#二、核心实体)
  - [2.1 TaskJob（任务定义）](#21-taskjob（任务定义）)
  - [2.2 TaskLog（任务执行日志）](#22-tasklog（任务执行日志）)
- [三、核心服务](#三、核心服务)
  - [3.1 TaskSchedulerService](#31-taskschedulerservice)
  - [3.2 TaskJobService](#32-taskjobservice)
  - [3.3 TaskLogService](#33-tasklogservice)
- [四、控制器与 API](#四、控制器与-api)
  - [4.1 Create / Update 请求体示例](#41-create-update-请求体示例)
- [五、开发自定义任务](#五、开发自定义任务)
  - [5.1 实现 IJob](#51-实现-ijob)
  - [5.2 通过管理界面登记](#52-通过管理界面登记)
  - [5.3 任务参数的读取约定](#53-任务参数的读取约定)
- [六、常用 Cron 表达式（Quartz 格式）](#六、常用-cron-表达式（quartz-格式）)
- [七、注意事项与最佳实践](#七、注意事项与最佳实践)
- [八、内置任务列表](#八、内置任务列表)
- [九、模块主要文件结构](#九、模块主要文件结构)
  - [关键配置项（appsettings.json）](#关键配置项（appsettingsjson）)
