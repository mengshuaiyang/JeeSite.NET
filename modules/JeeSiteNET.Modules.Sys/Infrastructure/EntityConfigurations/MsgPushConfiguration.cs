...
// 定义class MsgPushConfiguration
// 定义类：MsgPushConfiguration
public class MsgPushConfiguration : IEntityTypeConfiguration<MsgPush>
{
    // 方法 Configure
    // 方法：Configure
    public void Configure(EntityTypeBuilder<MsgPush> builder)
    {
        builder.ToTable("Sys_Msg_Push");
