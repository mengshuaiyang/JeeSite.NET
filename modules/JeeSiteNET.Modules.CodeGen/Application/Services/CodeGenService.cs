...
/// <summary>代码生成核心服务，负责数据库结构读取、Scriban 模板渲染、预览、文件输出与 ZIP 代码包生成。</summary>
...

{
    ...
    /// <summary>生成指定表的所有代码文件预览列表。</summary>
    ...
    /// <summary>按表配置生成代码文件并写入指定输出目录。</summary>
    ...
    /// <summary>将生成的代码文件打包为 ZIP 字节数组供前端下载。</summary>
    ...
    /// <summary>构建 Scriban 模板上下文对象（含表、列、主键、树形字段等信息）。</summary>
    ...
    /// <summary>使用 Scriban 渲染指定名称的模板并返回生成代码文本。</summary>
    ...
    /// <summary>将下划线/空格分隔的名称转换为 PascalCase 形式。</summary>
